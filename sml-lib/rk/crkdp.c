...
int Dormand_Prince_5_4(int, void (*f)(double,double*,double*,double*), double *p, double *y, double x, double h, double *yout, double *err,
...
int Dormand_Prince_5_4(int n, void (*f)(double,double *,double *,double *), double *p, double *y, double x0, double h, double *yout, double *err,
                       double *k1, double *k2, double *k3, double *k4, double *k5, double *k6, double *k7, 
