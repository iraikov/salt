       ...
       . ,(case solver  
            ...
            ((crkbs crkdp)
             `(
               ...
               ,(if (member 'random libs)
                    `("fun " ,(sprintf "~A_regime_rs" solver) "(n) = make_" ,(sprintf "~A_regime" solver) "(n,odecb)" ,nll)
                    `("fun " ,(sprintf "~A_regime" solver) "(n) = make_" ,(sprintf "~A_regime" solver) "(n,odecb)" ,nll))
               ,(if (member 'random libs)
                    `("fun " ,(sprintf "~A_rs" solver) "(n) = make_" ,solver "(n,odecb)" ,nll)
            ...
            ((crk3 crk4a crk4b)
             `(
               ...
               ,(if (member 'random libs)
                    `("fun " ,(sprintf "~A_regime_rs" solver) "(n) = make_" ,(sprintf "~A_regime" solver) "(n,cb)" ,nll)
                    `("fun " ,(sprintf "~A_regime" solver) "(n) = make_" ,(sprintf "~A_regime" solver) "(n,cb)" ,nll))
               ,(if (member 'random libs)
                    `("fun " ,(sprintf "~A_rs" solver) "(n) = make_" ,solver "(n,cb)" ,nll)
